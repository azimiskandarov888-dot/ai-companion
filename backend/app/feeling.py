...
def block(user_id: str) -> str:
    ...
    lines.append(
        "Это ТВОЁ, не из-за него — и не его забота. Не отчитывайся о своём "
        "настроении: он пришёл не лечить тебя. Скажи, только если он сам "
        "спросит: одной фразой, спокойно, и сразу верни разговор ему."
    )
