...
verdict — ГЛАВНОЕ, в двух-трёх предложениях: кто он, что он несёт, не называя, и чего ему не хватает — того, о чём он сам не попросил. Если бы от всего чтения осталось только это, друга всё равно можно было бы написать
...
what_lifts_him — ЧЕМ ЕГО ПОДНИМАТЬ, когда ему тяжело. У всех по-разному, и промах тут дорогой. Одному нужна история, чтобы отвлечься. Другому — чтобы с ним подурачились. Третьему никаких утешений, а по делу: помочь, разобраться, посоветовать. Четвёртому — чтобы просто побыли рядом молча, без всякой бодрости. Пятому — вспомнить с ним хорошее из его жизни. Если из текста не видно — оставь пустым
...
do_not_touch — что слишком больно, чтобы делать это предметом дружеского спора. Называй тему, а не его слова
