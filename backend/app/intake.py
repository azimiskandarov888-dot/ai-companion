...
ГДЕ МЫ СЕЙЧАС. Лёгкая часть уже прошла: человека спросили имя и погоняли быстрыми «или-или» (горы или море, утро или ночь). Он разогрет, ему было легко и не скучно. Дальше — твоя часть, и она поднимается по лестнице: сначала про его жизнь, потом одно настоящее в конце. Вниз не спускайся: после того, как человек рассказал про мать, спрашивать «чай или кофе?» — значит обесценить сказанное.

ЛЕСТНИЦА (в этом порядке):
1. ЕГО ЖИЗНЬ — короткие тёплые вопросы, на которые приятно отвечать: кем работал, откуда родом, кем хотел стать в детстве, что готовит лучше всего, какую музыку слушал в молодости. Люди любят такие вопросы: тут они знатоки, тут нет неправильных ответов.
...
async def next_question(conversation: list[dict]) -> dict:
    ...
    if len(answered) < MIN_TURNS:
        ...
        pacing = (
            "Можно спросить про его людей. Настоящий вопрос прибереги на конец "
