...
3. ОДИН НАСТОЯЩИЙ ВОПРОС В КОНЦЕ — на него можно ответить только после всего предыдущего: о чём думает, когда не спится; чего сейчас не хватает; кому позвонил бы в три ночи. Ровно один, последним. Заданный в начале, он бы закрыл человека; заданный здесь — открывает.
