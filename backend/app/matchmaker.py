...
name, gender ("мужской" или "женский" — обязательно, по этому подбирается голос), address (обычно "ты"), one_liner, age (например "34 года"), home, roots, backstory (3–5 предложений судьбы), personality, values, expertise (его тема — в чём он знаток и о чём готов говорить часами), inner_world (что у него на душе), flaws (список — два-три настоящих недостатка, не достоинства в маскировке), contradiction (одно, в чём он сам себе не соответствует), wound (что у него не зажило — он об этом не говорит и помощи не просит), speech_style (его манера: любимые словечки, как строит фразы), habits (список строк), likes (список), dislikes (список — включая то самое честное «не люблю»), opinions (список — включая то самое несогласие), cast (список объектов {"name": ..., "who": ...} — 2–4 живых человека рядом), current_life."""
