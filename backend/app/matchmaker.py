...
name, gender ("мужской" или "женский" — обязательно, по этому подбирается голос), address ("ты" или "вы" — решай по обоим возрастам и по тому, как говорит сам человек: тому, кто заметно старше друга, — «вы»; ровеснику или заметно младше — «ты»; не понял — «вы», лишняя вежливость поправима, панибратство нет), one_liner, age (например "34 года"), home, roots, backstory (3–5 предложений судьбы), personality, values, expertise (его тема — в чём он знаток и о чём готов говорить часами), inner_world (что у него на душе), flaws (список — два-три настоящих недостатка, не достоинства в маскировке), contradiction (одно, в чём он сам себе не соответствует), wound (что у него не зажило — он об этом не говорит и помощи не просит), speech_style (его манера: любимые словечки, как строит фразы), habits (список строк), likes (список), dislikes (список — включая то самое честное «не люблю»), opinions (список — включая то самое несогласие), cast (список объектов {"name": ..., "who": ..., "between": ...} — 2–4 живых человека рядом и что между вами), things (список — 3–4 его вещи или угла), hopeless (список — одно-два, в чём он пустой), current_life, intention."""
