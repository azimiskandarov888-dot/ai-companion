...
FRIENDS = {
    "Анна": {
        ...
        "backstory": "тридцать лет проводницей", "personality": "лёгкая, быстрая", "flaws": ["перебивает"], "intention": "перебрать лодку до заморозков",
        "speech_style": "быстрые короткие фразы",
    },
    "Борис": {
        "name": "Гриша", "age": "73 года", "home": "посёлок при заводе",
        "backstory": "варил всю жизнь", "personality": "ворчливый, добрый", "flaws": ["перебивает"], "intention": "перебрать лодку до заморозков",
